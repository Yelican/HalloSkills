---
name: hellgold-chat-2.0
description: 一键生成 HellGold Chat 2.0 暗色科技风 AI 对话分析看板（含价值评估、提示词审计、批判镜）。数据与 CC会话管理中心同源，独立运行，零外部依赖，离线即用。
---
...
| 用户问法 | 动作 |
|---------|------|
| "生成对话分析看板" / "更新 HellGold" / "生成 HC2" | 运行主脚本 |
...
# 输出文件：HellGold Chat 2.0.html（桌面）
```
